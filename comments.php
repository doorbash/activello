...
<div id="comments" class="comments-area">
	...
	<?php comment_form(
		array(
			'fields' => $fields,
			'label_submit' => __( 'ارسال پاسخ', 'activello' ),
			'comment_notes_before' => '',
			'comment_field' => '<textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" placeholder="'. esc_attr( _x( 'دیدگاه', 'comment form placeholder', 'activello' ) ).'"></textarea>',
		)
	); ?>
