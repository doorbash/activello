...
function activello_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			<?php
				previous_post_link( '<div class="nav-previous">%link</div>', _x( '<i class="fa fa-chevron-right"></i> %title', 'Previous post link', 'activello' ) );
				next_post_link(     '<div class="nav-next">%link</div>',     _x( '%title <i class="fa fa-chevron-left"></i>', 'Next post link',     'activello' ) );
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
