					...
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						<header class="entry-header">
							...
							<nav role="navigation" id="image-navigation" class="navigation-image nav-links">
								<div class="nav-previous"><?php previous_image_link( false, __( '<i class="fa fa-chevron-right"></i> Previous', 'activello' ) ); ?></div>
								<div class="nav-next"><?php next_image_link( false, __( 'Next <i class="fa fa-chevron-left"></i>', 'activello' ) ); ?></div>
